            ...
            <form class="am-form">
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $user->id }}</td>
                            <td class="brand_logo"><img src="{{ $user->headimgurl }}" alt="" class="am-radius"/></td>
                            <td>{{ $user->nickname }}</td>
                            <td>{{ $user->openid }}</td>
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="{{ route('admin.brand.edit', $user->id) }}">
