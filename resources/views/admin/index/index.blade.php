...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>长乐商城系统</small></div>
  </div>
  ...
  <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
    ...
    <li><a href="#" class="am-text-secondary"><span class="am-icon-btn am-icon-user-md"></span><br/>会员数<br/>3000</a></li>
  </ul>
  ...
  <div class="am-g">
    <div class="am-u-sm-12">
      <table class="am-table am-table-bd am-table-striped admin-content-table">
        <thead>
        <tr>
          <th>ID</th><th>昵称</th><th>最后成交商品</th><th>成交订单</th><th>管理</th>
        </tr>
        </thead>
        <tbody>
      ...
      <div class="am-panel am-panel-default">
        ...
        <div id="collapse-panel-2" class="am-in">
          <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
            ...
            <tr>
              <td class="am-text-center"><img src="{{ asset('amaze/i/examples/admin-chrome.png') }}" alt=""></td>
              <td>Google Chrome</td>
              <td>3,005</td>
            </tr>
            <tr>
              <td class="am-text-center"><img src="{{ asset('amaze/i/examples/admin-firefox.png') }}" alt=""></td>
              <td>Mozilla Firefox</td>
              <td>2,505</td>
            </tr>
            <tr>
              <td class="am-text-center"><img src="{{ asset('amaze/i/examples/admin-ie.png') }}" alt=""></td>
              <td>Internet Explorer</td>
              <td>1,405</td>
            </tr>
            <tr>
              <td class="am-text-center"><img src="{{ asset('amaze/i/examples/admin-opera.png') }}" alt=""></td>
              <td>Opera</td>
              <td>4,005</td>
            </tr>
            <tr>
              <td class="am-text-center"><img src="{{ asset('amaze/i/examples/admin-safari.png') }}" alt=""></td>
              <td>Safari</td>
              <td>505</td>
            </tr>
            </tbody>
